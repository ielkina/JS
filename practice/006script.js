...
let name2 = "Ilya";
alert(`hello ${1}`); // "hello 1" выражение - число 1
alert(`hello ${"name2"}`); // "hello name2" выражение - строка "name2"
alert(`hello ${name2}`); // "hello Ilya" выражение - переменная, вставим 
//её в строку